...
def parse_arguments(params):
    ...
    # Insert options
    insert_usage = "GameTracker insert [-h] (-f FILE [--no-header] | -m) -t TYPE"
    ...
    try:
        ...
        if res["mode"] == "insert" and res["insert_manual_flag"] and res["header_flag"]:
            print("usage: " + insert_usage)
            print("error: GameTracker print: error: argument --no-header: not allowed with argument -m/--manual")
            exit(-1)
